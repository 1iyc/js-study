...
window.onload = function() {
	...
	img.onload = function() {
		...
		canvas.addEventListener("mousemove", function(e) {
			...
			mouseInBlock1 = contains(block1, mouse);
		});
		canvas.addEventListener("click", function(e) {
			if (mouseInRect) {
				if (expanded) {
					elasticRect.resize(50, 100, 200, 300);
				} else {
					elasticRect.resize(25, 50, 800, 400);
				}
				expanded = !expanded;
			}
			else if (mouseInBlock1) {
				if (expanded1) {
					block1.resize(260, 100, 200, 145);
				} else {
					block1.resize(25, 50, 800, 400);
				}
				expanded1 = !expanded1;
			}
		});
	...
	elasticRect = new ElasticRect(50, 100, 200, 300);

	block1 = new ElasticRect(260, 100, 200, 145);
};
...
function draw() {
	...
	ctx.fillText(buttonText, 150, 250);
}
