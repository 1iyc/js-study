...
ElasticRect.prototype = {
    ...
    resize:function(x, y, w, h) {
        ...
        tl.to(this.p0, 0.3, {x:x, y:y, ease:Cubic.easeIn}, Math.random() * 0.25);
        tl.to(this.p1, 0.3, {x:x + w, y:y, ease:Cubic.easeIn}, Math.random() * 0.25);
        tl.to(this.p2, 0.3, {x:x + w, y:y + h, ease:Cubic.easeIn}, Math.random() * 0.25);
        tl.to(this.p3, 0.3, {x:x, y:y + h, ease:Cubic.easeIn}, Math.random() * 0.25);

        tl.to(this.c0, 2, {x:x + w * 0.5, y:y, ease:Elastic.easeOut, easeParams:this.elasticParams}, Math.random() * 0.5);
        tl.to(this.c1, 2, {x:x + w, y:y + h * 0.5, ease:Elastic.easeOut, easeParams:this.elasticParams}, Math.random() * 0.5);
        tl.to(this.c2, 2, {x:x + w * 0.5, y:y + h, ease:Elastic.easeOut, easeParams:this.elasticParams}, Math.random() * 0.5);
        tl.to(this.c3, 2, {x:x, y:y + h * 0.5, ease:Elastic.easeOut, easeParams:this.elasticParams}, Math.random() * 0.5);
    },
    draw:function() {
        ...
        ctx.bezierCurveTo(this.c0.x, this.c0.y, this.c0.x, this.c0.y, this.p1.x, this.p1.y);
        ctx.bezierCurveTo(this.c1.x, this.c1.y, this.c1.x, this.c1.y, this.p2.x, this.p2.y);
        ctx.bezierCurveTo(this.c2.x, this.c2.y, this.c2.x, this.c2.y, this.p3.x, this.p3.y);
        ctx.bezierCurveTo(this.c3.x, this.c3.y, this.c3.x, this.c3.y, this.p0.x, this.p0.y);
        ctx.fill();
    }
};
